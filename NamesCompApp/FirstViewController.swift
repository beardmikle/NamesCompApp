...
//  NamesCompApp
//
//  Created by beardmikle on 02.01.2023.
//
...
class FirstViewController: UIViewController {
    ...
    @IBAction func resultButtonTapped() {
        ...
        if firstName.isEmpty || secondName.isEmpty {
            showAlert(
                title: "❗️ Names are missing ❗️",
                message: "Please enter both name 😕"
            )
         return
        }
    ...
    @IBAction func unwindSegueToFirstVS(segue: UIStoryboardSegue) {
        yourNameTF.text = ""
        partnerNameTF.text = ""
    }
}
